...
def test_resolvconf_content(host):
    ...
    expected_nameservers_default = get_variable(
        host, "resolvconf_nameserver_default")
    expected_nameservers_extra = get_variable(
        host, "resolvconf_nameserver_extra")

    expected_nameservers = jinja_list_concat(
        expected_nameservers,
        [expected_nameservers_default, expected_nameservers_extra])
