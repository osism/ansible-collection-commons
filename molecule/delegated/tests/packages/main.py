...
def test_required_packages_installed(host):
    ...
    required_packages_distribution = get_os_role_variable(host, "required_packages_distribution")

    required_packages = jinja_list_concat(required_packages, [required_packages_default, required_packages_extra,
